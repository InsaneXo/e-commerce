...
const Catagory = () => {
  const categoriesItems = [
...

    {
      title: "Chain Pendant",
      subTitle: "Exclusives Collection",
      image: require("../../assets/images/chainPendant.BG.jpg"),
      products: [
        {
          id: "1",
    ...
    },
    {
      title: "Bracelets",
      subTitle: "Exclusives Collection",
      image: require("../../assets/images/braceletBg.jpg"),
      products: [
        {
          id: "1",
    ...
    },
    {
      title: "Bangles",
      subTitle: "Exclusives Collection",
      image: require("../../assets/images/banglesBG.jpg"),
      products: [
        {
          id: "1",
    ...
    },
    {
      title: "Belts",
      subTitle: "Exclusives Collection",
      image: require("../../assets/images/beltsBg.jpg"),
      products: [
        {
          id: "1",
